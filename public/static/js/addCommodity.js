...
$(document).ready(function() {
    ...
    $(AddButton).click(function (e)  //on add input button click
    {
        if(x <= MaxInputs) //max input box allowed
        {
            ...
            //add input box
            $(InputsWrapper).append('<div>参数名：<input type="text" name="parameterName" style=" height:30px;width: 180px ">；参数值：<input type="text" style=" height:30px;width: 180px " name="parameterValue" id="field_'+ FieldCount +'"/>' +
